...
* 윈도우10 기준
    ...
    * 3. 설치중 Tools for Native Modules에서 체크박스 표시
    * 4. 파워쉘 설치까지 끝난후 명령 프롬프트 실행
    * 5. 명령 프롬프트에서 **node -v** 입력
    * 6. 명령 프롬프트에서 **npm -v** 입력
    * 7. 버전이 다 나오면 설치 성공 (에러 메세지가 나오면 노드를 처음부터 다시 설치)
* 맥 기준
    * 1. 맥 안씀
